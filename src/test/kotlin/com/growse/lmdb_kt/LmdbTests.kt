		...
		fun databasesWithKeysValues(): Stream<Arguments> = /*
			...
			Stream.of(
				...
				arguments(
					...
					4096,
					mapOf(
						byteArrayOf(0, 0, 0, 0, 0, 0, 0, 0) to
							LengthAndDigest(224, "92ac74587530bc80322bffe124720811"),
						byteArrayOf(0, 0, 0, 0, 0, 0, 0, 1) to
							LengthAndDigest(744, "989463ef7b13d183dfda5bb08c47d37b"),
					),
				),
			)
	}
